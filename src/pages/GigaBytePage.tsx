        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-32">
          {[
            { 
              ...
              price: '149', 
              desc: 'For travelers seeking authentic heritage and village life.',
              features: ['Biometric Visa Invite', 'Licensed Cultural Guide', 'Heritage Stay Booking', '24/7 Logistics Support']
            },
            { 
              title: 'Mountain Expedition', 
              price: '349', 
              desc: 'Comprehensive 4x4 support for high-altitude treks.',
              features: ['Everything in Discovery', 'Toyota Prado/Hilux Rental', 'Satellite SOS Comms', 'Emergency Heli-Evac Prep', 'Specialized Pack Animals'],
              popular: true
            },
            { 
              title: 'Elite Traverse', 
              price: '649', 
              desc: 'Full-service luxury for group expeditions.',
              features: ['Everything in Expedition', 'V8/Fortuner Fleet', 'Solar Field Power', 'Dedicated Expedition Chef', 'Specialist Photography Service']
            },
          ].map((plan, i) => (
            <motion.div
              key={i}
